...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
	<form action="adInfoController/updAdInfo.do" name="adInfoForm" id="adInfoForm" method="post" enctype="multipart/form-data">
	<input type="hidden" name="purl" value="${pd.AD_PURL }">
	<input type="hidden" name="suburl" value="${pd.AD_SUBURL }">
	   <div class="big_box1">
    	<ul class="table">
        ...
        <div class="big_box2" id="dv1">
            ...
            <ul>
                ...
                <li>
                    <input type="text" id="adTitle" name="adTitle" value="${pd.AD_TITLE}">
                     <input type="hidden" id="adId" name="adId" value="${pd.AD_ID}">
                </li>
                <div class="clearfix"></div>
            </ul>
             ...
             <ul>
                ...
                <li>
                    <input type="text" id="adSequence" name="adSequence" value="${pd.AD_SEQUENCE}">
                </li>
                <div class="clearfix"></div>
            </ul>
            ...
            <ul>
                ...
                <c:if test="${pd == null || pd.AD_PURL == '' || pd.AD_PURL == null }">
            ...
            <ul>
                <li id="pic">
                	<c:if test="${pd != null && pd.AD_PURL != '' && pd.AD_PURL != null }">
						<img src="<%=basePath%>uploadFiles/uploadImgs/${pd.AD_PURL}"  width=350px; height=300px/>
						<input type="button" class="btn btn-mini btn-danger" value="删除" onclick="delP('${pd.AD_PURL}','${pd.AD_ID}');" style="width: 39px;"/>
						<input type="hidden" name="tpz" id="tpz" value="${pd.AD_PURL }"/>
					</c:if>
                </li>
                <div class="clearfix"></div>
            </ul>
        ...
        <div class="big_box2" id="dv2" style="display: none;">
            ...
            <ul>
                ...
                <li>
                    <input type="text" id="adSubtitle" name="adSubtitle" value="${pd.AD_SUBTITLE}">
                </li>
                <div class="clearfix"></div>
            </ul>
             ...
             <ul class="content mbottom10">
                ...
                <li>
                    <textarea id="adSubinfo" name="adSubinfo">${pd.AD_SUBINFO}</textarea>
                </li>
                <div class="clearfix"></div>
            </ul>
             <ul>
                ...
                <c:if test="${pd == null || pd.AD_SUBURL == '' || pd.AD_SUBURL == null }">
            ...
            <ul>
                <li id="pics">
                    <c:if test="${pd != null && pd.AD_SUBURL != '' && pd.AD_SUBURL != null }">
                    	<img src="<%=basePath%>uploadFiles/uploadImgs/${pd.AD_SUBURL}"  width=350px; height=300px/>
						<input type="button" class="btn btn-mini btn-danger" value="删除" onclick="delS('${pd.AD_SUBURL}','${pd.AD_ID}');" style="width: 39px;"/>
						<input type="hidden" name="tpzs" id="tpzs" value="${pd.AD_SUBURL }"/>
					</c:if>
                </li>
                <div class="clearfix"></div>
            </ul>
...
/* 		if($("#edu_title").val()==""){
	...
	//删除图片
	function delP(PATH,AD_ID){
		if(confirm("确定要删除图片？")){
			var url = "adInfoController/delTxiang.do?PATH="+PATH+"&adId="+AD_ID;
	...
	//删除图片
	function delS(PATH,AD_ID){
		if(confirm("确定要删除图片？")){
			var url = "adInfoController/delTxiangs.do?PATH="+PATH+"&adId="+AD_ID;
			$.get(url,function(data){
				if(data=="success"){
					alert("删除成功!");
					 window.location.reload();
