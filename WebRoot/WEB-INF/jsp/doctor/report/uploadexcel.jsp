		...
		<script type="text/javascript">
			...
			function fileType(obj){
			    ...
			    if(fileType != '.xls' && fileType != '.xlsx'){
			    	...
			    	$("#excel").val('');
			    	document.getElementById("excel").files[0] = '请选择Excel文件';
			    }
			}
		</script>
	</head>
	<body>
		<form action="${action}" name="Form" id="Form" method="post" enctype="multipart/form-data">
			<div id="zhongxin" style="">
				<table style="width:90%;margin:auto;">
					...
					<tr>
						<td style="text-align: center;">
							...
							<a class="btn btn-mini btn-danger" onclick="parent.layer.closeAll();">取消</a>
							<a class="btn btn-mini btn-success" href="${url}">下载模版</a>
						</td>
					</tr>
				</table>
			</div>
