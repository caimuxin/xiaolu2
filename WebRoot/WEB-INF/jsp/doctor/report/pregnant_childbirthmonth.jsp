...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			<!-- 检索  -->
		<form action="report/childbirthmonthlist.do" method="post" name="userInfoForm" id="userInfoForm">
			<div class="big_box">
				...
				<c:choose>
				<c:when test="${not empty pd && not empty cmList}">
		       	<c:forEach items="${cmList}" var="cm">
		        	<tr>
		            	<td class="td_left" >${cm.cmcounties}</td>
		                <td>${cm.cmchildbirthsum}</td>
		                <td>${cm.cmhighrisk}</td>
		                <td>${cm.cmnature}</td>
		                <td>${cm.cmvaginasum}</td>
		                <td>${cm.cmfetalhead}</td>
		                <td>${cm.cmhaunch}</td>
		                <td>${cm.cmhiptraction}</td>
		                <td>${cm.cmforceps}</td>
		                <td>${cm.cmother}</td>
		                
		            	<td>${cm.cmcesareansum}</td>
		                <td>${cm.cmmedicine}</td>
		                <td>${cm.cmnomedicine}</td>
		                <td>${cm.cmlivebirthsum}</td>
		                <td>${cm.cmboy}</td>
		                <td>${cm.cmgirl}</td>
		                <td>${cm.cmunknown}</td>
		                <td>${cm.cmlivebirth}</td>
		                <td>${cm.cmstillbirths}</td>
		                <td>${cm.cmstillbirth}</td>
		          	</tr>
		      </c:forEach>
		      </c:when>
		    ...
		    <c:if test="${not empty pd && not empty cmList}">
